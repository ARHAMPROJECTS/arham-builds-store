...
const PulseFeed: React.FC<PulseFeedProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f2ee] dark:bg-[#0b1120] transition-colors duration-700 font-sans selection:bg-blue-600 selection:text-white no-scrollbar pb-40">
           ...
           <div className="flex flex-col items-center text-center">
              <div className="relative mb-8">
                 <div className="w-24 h-24 md:w-28 md:h-28 rounded-full p-[3px] bg-gradient-to-tr from-blue-600 via-blue-400 to-indigo-500 shadow-xl shadow-blue-500/10">
                    <div className="w-full h-full rounded-full border-[3px] border-[#f4f2ee] dark:border-[#0b1120] overflow-hidden bg-white shadow-inner">
                      <img 
                        src={AVATAR_URL} 
          ...
          {PULSE_ARCHIVE.map((post, idx) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                 <div className="w-8 h-8 rounded-full overflow-hidden border border-gray-200/50 dark:border-white/5 bg-white/20">
                    <img 
                      src={AVATAR_URL} 
                      className="w-full h-full object-cover" 
                      alt="Arham Adib" 
                 ...
                 <div className="flex flex-col">
                    <div className="flex items-center gap-1.5">
                      <span className="text-[12px] font-bold text-gray-900 dark:text-white leading-none">arham.adib</span>
                      <PremiumVerifiedBadge size={13} className="mt-[-1px]" />
                    </div>
                    <span className="text-[9px] font-bold text-gray-400 dark:text-gray-600 uppercase tracking-widest mt-1">{post.date}</span>
                 </div>
              </div>
